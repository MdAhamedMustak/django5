...
def categories_list_api_view(request):
    categories = [
        ...
        {"name": "Data Analyst", "slug": "data-analyst", "icon": "lni-chart-bars"},
        {"name": "Project Manager", "slug": "project-manager", "icon": "lni-briefcase"},
        {"name": "Data Entry", "slug": "data-entry", "icon": "lni-database"},
        {"name": "Java Developer", "slug": "java-developer", "icon": "lni-java"},
